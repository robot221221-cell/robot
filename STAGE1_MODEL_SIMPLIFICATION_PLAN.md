...
- `Stage1B_DistanceLOD_Run_v2_Opt/tables/baseline_summary.csv`
...
- [x] 完成 Stage-1A 几何资产替换并通过对齐验证
- [x] 完成 Stage-1A 冒烟测试（easy seed42）
- [x] 完成 Stage-1A 全量 30 组
- [x] 完成 Stage-1B（Distance-LOD）并全量 30 组
